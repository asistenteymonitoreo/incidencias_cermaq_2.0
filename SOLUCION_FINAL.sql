-- ==========================================================
-- SCRIPT DE EMERGENCIA: CONFIGURACIÓN INTEGRAL SUPABASE
-- ==========================================================
-- INSTRUCCIONES:
...
-- C) TABLAS DE LA APP INCIDENCIAS
...
-- D) USUARIO ADMINISTRADOR (admin / admin123)
-- Generado con hash compatible con Django
...
-- E) MARCAR MIGRACIONES COMO COMPLETADAS
...
-- F) MENSAJE FINAL
SELECT '✅ TODO LISTO: Tablas creadas y usuario admin@admin123 configurado.' AS status;
